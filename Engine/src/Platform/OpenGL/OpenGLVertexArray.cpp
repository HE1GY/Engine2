        ...
        for (const auto& element : layout) {
            ...
            case ShaderDataType::Mat4:
                ...
                glVertexAttribPointer(m_vertexBuffer_index, element.GetComponentCount(),
                    ShaderDataTypeToOpenGL(element.type), element.normalized ? GL_TRUE : GL_FALSE, layout.GetStride(),
            ...
            case ShaderDataType::Int4:
                ...
                glVertexAttribIPointer(m_vertexBuffer_index, element.GetComponentCount(),
                    ShaderDataTypeToOpenGL(element.type), layout.GetStride(), (GLenum*) element.offset);
                m_vertexBuffer_index++;
                break;
            }
        }
